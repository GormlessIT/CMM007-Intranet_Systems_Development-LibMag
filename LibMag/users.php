...
elseif ($method === 'PUT') {
    ...
    if (isset($input['password']) && trim($input['password']) !== "") {
        ...
        $newHashedPassword = password_hash($input['password'], PASSWORD_DEFAULT);
        ...
        $stmt->bind_param("sssss", $username, $email, $newHashedPassword, $role, $oldEmail);
    } else {
        // No password provided - update other fields only
